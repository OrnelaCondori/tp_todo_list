...
export const tareaStore = create<ITareaStore> ((set) => ({
    ...
    agregarNuevaTarea:(nuevaTarea)=> set((state)=>({tareas: [...state.tareas, nuevaTarea]})), //atatea representa el valor de las variables a las que accedemos
    ...
    //eliminar una tareasb del array
